...
$(function () {
    ...
    if (savedGame !== undefined) {
        carGame.fuel = savedGame.fuel;
        carGame.fuelMax = savedGame.fuelMax;
        carGame.currentLevel = savedGame.currentLevel;
        carGame.currentStatus = savedGame;
    }
...
function setSavedGame() {
    carGame.currentStatus = {
        state: carGame.state,
        fuel: carGame.fuel,
        fuelMax: carGame.fuel,
        currentLevel: carGame.currentLevel
    };
    localStorage['carGame'] = JSON.stringify(carGame.currentStatus);
}